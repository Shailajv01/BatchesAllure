...
public class BaseTest {
	...
	protected BatchesLoginPage loginpage = null;
	protected CreateBatchPage createBatchPage = null;
	...
	protected enum WEB_DRIVER {
		...
		LOGIN_DRIVER, FORGOT_PASSWORD_DRIVER;
	}
	...
	public void login() throws Exception {
		loginpage.setOrgCode(testDataprop.getProperty("text.org.code"));
