...
public class BasePage {
	 ...
	 * 
	 * logger.info("Starting of getPastDate method"); LocalDate pastDate =
	 * LocalDate.now().minusDays(5); logger.info("Ending of getPastDate method");
	 * 
	 * return pastDate; }
	 */
	...
	public int geCurrentDateTimeExample() {
		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
		LocalDate currentDate = LocalDate.now();
		int year = (int) currentDate.getYear();
